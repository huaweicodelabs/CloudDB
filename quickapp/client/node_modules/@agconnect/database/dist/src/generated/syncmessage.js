...
export const naturalcloudsyncv2 = $root.naturalcloudsyncv2 = (() => {
    ...
    naturalcloudsyncv2.SchemaField = (function() {
         ...
         * @instance
         */
        SchemaField.prototype.bl = false;
         ...
         * @instance
         */
        SchemaField.prototype.l = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
         ...
         * @instance
         */
        SchemaField.prototype.d = 0;

        /**
         * SchemaField ba.
         * @member {Uint8Array} ba
         * @memberof naturalcloudsyncv2.SchemaField
         * @instance
         */
        SchemaField.prototype.ba = $util.newBuffer([]);
        ...
        SchemaField.toObject = function toObject(message, options) {
            ...
            if (message.n != null && message.hasOwnProperty("n"))
                object.n = message.n;
            if (message.t != null && message.hasOwnProperty("t"))
                object.t = options.enums === String ? $root.naturalcloudsyncv2.FieldType[message.t] : message.t;
            if (message.p != null && message.hasOwnProperty("p"))
                object.p = message.p;
            if (message.e != null && message.hasOwnProperty("e"))
                object.e = message.e;
    ...
    naturalcloudsyncv2.Field = (function() {
         ...
         * @instance
         */
        Field.prototype.l = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
         ...
         * @instance
         */
        Field.prototype.ba = $util.newBuffer([]);
    ...
    naturalcloudsyncv2.EncryptionInfo = (function() {
        ...
        EncryptionInfo.fromObject = function fromObject(object) {
            ...
            if (object.firstSalt != null)
                ...
                else if (object.firstSalt.length)
            ...
            if (object.secondSalt != null)
                ...
                else if (object.secondSalt.length)
            ...
            if (object.rootToken != null)
                ...
                else if (object.rootToken.length)
            ...
            if (object.oldCipherText != null)
                ...
                else if (object.oldCipherText.length)
    ...
    naturalcloudsyncv2.AggregateQueryResult = (function() {
         ...
         * @instance
         */
        AggregateQueryResult.prototype.longRes = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * AggregateQueryResult doubleRes.
         * @member {number} doubleRes
         * @memberof naturalcloudsyncv2.AggregateQueryResult
         * @instance
         */
        AggregateQueryResult.prototype.doubleRes = 0;
