...
import { SubScribeRange } from './NaturalCloudSyncModule';
...
export interface SyncTaskHandler {
    onOpenStore(store: NaturalStore): Promise<ErrorCode>;
    onCloseStore(store: NaturalStore): void;
    ...
    onSubscribe(subscribeType: SubScribeRange, store?: NaturalStore, defaultSubscribeInfo?: [number, string, string]): Promise<ErrorCode>;
