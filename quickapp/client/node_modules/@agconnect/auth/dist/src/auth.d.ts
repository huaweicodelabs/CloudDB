import { AGCAuth, AGConnectAuthCredential, AGConnectUser, Persistence, SignInResult, PhoneUser, EmailUser, OnTokenListener, Crypt, VerifyCodeResult } from '@agconnect/auth-types';
