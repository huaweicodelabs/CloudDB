...
export declare function pathLengthSpec(validator?: (p1: unknown) => void | null, optional?: boolean): ArgSpec;
...
export declare function forbiddenSymbol(string: unknown): void;
...
export declare function validatorArea(param: unknown): void;
